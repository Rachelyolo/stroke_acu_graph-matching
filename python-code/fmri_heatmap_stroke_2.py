...
cost_map_all_s = np.load("../fmri_costmap_output/before_costmap_stroke_Z.npy")
...
np.save("../threold_research/fmri_stroke_node.npy", transform_matrix_all)
...
plt.savefig("../fmri_heatmap_output/fmri_before_stroke_heatmap_percent_Z.png")
...
plt.savefig("../fmri_heatmap_output/fmri_before_stroke_heatmap_num_Z.png")