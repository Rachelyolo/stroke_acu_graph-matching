...
cost_map_all_s = np.load("../fmri_costmap_output/before_costmap_health_Z.npy")
...
for i in range(health_num):
    ...
    ax.invert_yaxis()
    file = "../fmri_permutation_output/health_Person_Z_" + str(i+1) + ".png"
    plt.savefig(file)
...
np.save("../threold_research/fmri_health_node.npy", transform_matrix_all)
...
np.save("../threold_research/fmri_health.npy", network_trans)
np.save("../fmri_heatmap_output/fmri_before_health_network_Z.npy", network_trans)
...
plt.savefig("../fmri_heatmap_output/fmri_before_health_heatmap_percent_Z.png")
...
plt.savefig("../fmri_heatmap_output/fmri_before_health_heatmap_num_Z.png")