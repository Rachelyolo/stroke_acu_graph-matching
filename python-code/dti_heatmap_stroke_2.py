...
def run(gamma, path):
    ...
    path_node = "../threold_research/dti_stroke_node_" + str(gamma) + ".npy"
    print("所有病人dti变换综合的443*443矩阵保存在：", path_node)
...
#         ax.invert_yaxis()
#         path = "../dti_permutation_output/stroke_Person_" + str(i+1) + ".png"
#         plt.savefig(path)
#
#
#     network_load = {}
...
#
#     network_trans_num_save = pd.DataFrame(network_trans_num)
#     network_trans_num_save.to_csv("sss.csv")
#
#     np.save("../threold_research/dti_stroke.npy", network_trans)
#
...
#     plt.savefig("../dti_heatmap_output/dti_after_flip_stroke_heatmap_percent.png")
#
#     data={}
#
#
...
#
#     plt.savefig("../dti_heatmap_output/dti_after_flip_stroke_heatmap_num.png")
# # plt.show()