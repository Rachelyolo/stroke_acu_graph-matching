...
def run(gamma):
    ...
    path = "../num/fmri_health_num_" + str(gamma) + ".xlsx"
    ...
    for i in range(transform_matrix_s.shape[0]):
        ...
        path = "../csv_output_fmri_health/"
        if i<10:
            path_1 = path + "0" + str(i) + "fmri_health_" + str(gamma) + ".csv"
            network_trans_save.to_csv(path_1)
        else:
            path_1 = path + str(i) + "fmri_health_" + str(gamma) + ".csv"
            network_trans_save.to_csv(path_1)
