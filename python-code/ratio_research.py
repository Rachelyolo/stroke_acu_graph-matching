...
def run(gamma, path1, path2):
    ...
    flag_matrix_fmri = np.zeros_like(fmri_health)
    ...
    pathmm = "flag_matrix_fmri_" + str(gamma)+".npy"
    np.save(pathmm, flag_matrix_fmri)
    ...
    transform_matrix_all = fmri_stroke
    temp_ls = 0
    mm = 0
    ...
    path = "../fmri_heatmap_output/fmri_stroke_heatmap_percent_sub_" + str(thr) +"_"+str(gamma)+ ".png"
    plt.savefig(path)
    #
    # data = {}
    #
    ...
    #     for j in range(fmri_health.shape[0]):
    #         if fmri_health[i, j] >= thr:
    #             print(fmri_stroke_test[i, j])
    #             fmri_stroke_test[i, j] = 0
    #             print(fmri_stroke_test[i, j])
    # print(np.count_nonzero(fmri_stroke_test - fmri_stroke))
    # input()
    ...
    # sns.heatmap(data=pd_data, square=True)
    #
    # path = "../fmri_heatmap_output/fmri_before_stroke_heatmap_percent_Z_sub_" + str(thr) + ".png"
    # plt.savefig(path)
    #
    # data = {}
    #
