...
def run(gamma, path):
    ...
    #     ax.invert_yaxis()
    #     file = "../fmri_permutation_output/stroke_Person_Z_precision" + str(i+1) + ".png"
    #     plt.savefig(file)
    ...
    path1 = "../threold_research/fmri_stroke_node_" + str(gamma)+".npy"
    np.save(path1, transform_matrix_all)
    print("所有病人变换综合的443*443矩阵保存在：", path1)
    ...
    y_tick=['5','6','7','8','9','10','11','2','12','13','14','15','16','17','18','1']
    flag1 = 0
    flag2 = 0
    ...
    path2 = "../threold_research/fmri_stroke_network_" + str(gamma) + ".npy"

    np.save(path2, network_trans)
    print("所有病人变换综合的16*16矩阵(脑网络frequency文件)保存在：", path2)
    return path1, path2

    # np.save("../fmri_heatmap_output/fmri_after_stroke_network_precision.npy", network_trans)
    #
    ...
    # plt.savefig("../fmri_heatmap_output/fmri_after_stroke_heatmap_percent_precision.png")
    #
    # data = {}
    #
    # for i in range(18):
    ...
    # sns.heatmap(data=pd_data, square=True)
    #
    # plt.savefig("../fmri_heatmap_output/fmri_after_stroke_heatmap_num_precision.png")
